CREATE Procedure SP_GetProductFeedBackAnalysis
As
Begin
...
from 
(
Select R.ProductName, R.CategoryDesc, FeedBackIndex,
...
Group By R.ProductName, R.CategoryDesc, FeedBackIndex
)t


select ProductName, CategoryDesc,
...
from #Temp
Group By ProductName, CategoryDesc
